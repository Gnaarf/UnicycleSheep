...
namespace UnicycleSheep
{
    class PlayerCharacter : PhysicsActor, IContactEvent
    {
        ...
        public override void draw(RenderWindow win, View view)
        {
            ...
            //SFML.Graphics.VertexArray lineFromWheelToBody_Debug = new VertexArray();
            //lineFromWheelToBody_Debug.Append(new Vertex(wheelSprite.Position));
            //lineFromWheelToBody_Debug.Append(new Vertex(body_Debug.Position));
            //win.Draw(lineFromWheelToBody_Debug);
        }
